    ...
    <section class="contacts row">
        ...
        <div class="col-lg-6 col-12 right">
            ...
            <?php if(ot_get_option('contacts_tel1')) { ?>
                <a href="tel:<?php echo str_replace(array(" ", "(", ")", "-"), "", ot_get_option('contacts_tel1')) ?>" class="tel">Тел.: <?php echo ot_get_option('contacts_tel1') ?></a>
            <?php } ?>
            <?php if(ot_get_option('contacts_tel2')) { ?>
                <a href="tel:<?php echo str_replace(array(" ", "(", ")", "-"), "", ot_get_option('contacts_tel2')) ?>" class="tel">Моб.тел.: <?php echo ot_get_option('contacts_tel2') ?></a>
            <?php } ?>
            ...
            <form method="post" id="contacs-form"  class="contacts-form">
                <label for="contacts-mail" class="label">Email</label>
                <input type="mail" name="contacts-mail" required id="contacts-mail" placeholder="example@mail.com">
                <textarea class="message" name="message" placeholder="Комментарий">
                </textarea>
