                ...
                <div class="service-item service-item-open ind-left">
                    ...
                    <div class="bottom">
                       <div class="ind-left-form">
                            <select class="ind-left-select" name="ind-left-select">
                ...
                <div class="service-item corp-left">
                    ...
                    <div class="bottom">
                        <div class="corp-left-form">
                            <select class="corp-left-select" name="corp-left-select">
                ...
                <?php 
                    ...
                    <div class="ind-right-form-cont">
                        <div class="ind-right-form">
                            <div class="wrap">
                                <div>
                                    <label for="right-brend" class="label">Бренд</label>
                            ...
                            <input type="file" id="ind_file" name="ind-file" style="opacity: 0;">
                            <label for="ind-tel" class="label" name="ind-tel">Телефон</label>
                            ...
                            <button type="button" class="btn ind-right-btn">Отправить</button>
                        </div>
                    </div>
                </div>
        ...
        <section class="services-select row">
            ...
            <div class="col-lg-6">
                <div class="select-form">
                    ...
                    <textarea class="textarea" placeholder="Комментарий"></textarea>
                    <button type="button" class="btn select-btn">Отправить</button>
                </div>
            </div>
        </section>
