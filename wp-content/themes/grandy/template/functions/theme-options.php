...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        'id'          => 'header_logo_desc',
        'label'       => 'Загрузите логотип(десктоп)',
        'desc'        => '',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header',
      ...
      array(
        'id'          => 'sales_on_off',
        'label'       => 'Включение/отключение объявления',
        'desc'        => '',
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header',
    ...
    array(
        'id'          => 'header_form_code',
        'label'       => 'Шорткод',
        'desc'        => 'Добавьте шорткод из contact form 7 сюда',
        'type'        => 'text',
        'section'     => 'footer',
    ),
    ...
    array(
        'id'          => 'home_page',
        'label'       => 'Главная страница секция 1',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          => 'main_block1_title1',
        'label'       => 'Заголовок 1',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'home_page_set',
    ...
    array(
        'id'          => 'home_page_2',
        'label'       => 'Главная страница секция 2',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          => 'home_page_2_upload',
        'label'       => 'Загрузите изображние мастера',
        'desc'        => '',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'home_page_set',
    ...
    array(
        'id'          => 'home_page_3',
        'label'       => 'Главная страница секция 3',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          =>'main_block2_title_gold',
    ...
    array(
        'id'          => 'home_page_5',
        'label'       => 'Главная страница секция 5',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          =>'main_block5_title_gold',
        'label'       => 'Золотой заголовок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'home_page_set',
    ...
    array(
        'id'          =>'main_block5_title_2',
        'label'       => 'Заголовок 2 (синий)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          =>'main_block5_title_3',
        'label'       => 'Заголовок 2 (золотой)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'home_page_set',
    ),
    array(
        'id'          =>'main_block5_title_4',
        'label'       => 'Заголовок 3',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'home_page_set',
    ...
    array(
     ...
     array(
        'id'          => 'main_block5_bg_mob',
        'label'       => 'Фон мобильная версия',
        'desc'        => '',
        'std'         => '',
        'type'        => 'background',
        'section'     => 'home_page_set',
    ...
    array(
        'id'          =>'tissue_block1_subtitle_gold',
        'label'       => 'Подзаголовок(золотой)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    ...
    array(
        'id'          =>'tissue_block2_subtitle_gold',
        'label'       => 'Текстовый блок золотой',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    ...
    array(
        'id'          =>'tissue_block3_content1',
        'label'       => 'Текстовый блок 1',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    array(
        'id'          =>'tissue_block3_content2',
        'label'       => 'Текстовый блок 2',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    ...
    array(
        'id'          =>'tissue_block4_subtitle_gold',
        'label'       => 'Подзаголовок(золотой)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ...
    array(
        'id'          =>'tissue_block4_content3',
        'label'       => 'Текстовый блок 3(моб)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    array(
        'id'          =>'tissue_block4_content4',
        'label'       => 'Текстовый блок 4(моб)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    ...
    array(
        'id'          =>'tissue_block5_content3',
        'label'       => 'Текстовый блок 3',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'tissue_page',
    ),
    ...
    array(
        'id'          => 'services_page_right1',
        'label'       => 'Первая секция слева',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'services_page',
    ),
    array(
        'id'          => 'services_right1_title',
        'label'       => 'Заголовок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ...
    array(
     ...
     array(
        'id'          => 'services_right1_grey',
        'label'       => 'Серый текст(гарантия)',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ),
    array(
        'id'          => 'services_page_right2',
        'label'       => 'Вторая секция слева',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'services_page',
    ),
    array(
        'id'          => 'services_right2_title',
        'label'       => 'Заголовок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ...
    array(
        'id'          => 'services_right21_desc',
        'label'       => 'Описание 1 блок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ),
     array(
        'id'          => 'services_right22_desc',
        'label'       => 'Описание 2 блок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ),
     array(
        'id'          => 'services_right23_desc',
        'label'       => 'Описание 3 блок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
    ),
     array(
        'id'          => 'services_page_right3',
        'label'       => 'Третья секция слева',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'services_page',
    ),
    array(
        'id'          => 'services_right3_title',
        'label'       => 'Заголовок',
        'desc'        => '',
        'type'        => 'text',
        'section'     => 'services_page',
