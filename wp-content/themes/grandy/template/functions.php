...
function grandy_scripts() {
    ...
    wp_enqueue_script('pdf', get_template_directory_uri() . '/js/pdfmake.min.js', array('jquery'));
    wp_enqueue_script('vfs', get_template_directory_uri() . '/js/vfs_fonts.js', array('pdf'));
