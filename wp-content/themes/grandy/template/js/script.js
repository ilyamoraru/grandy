...
jQuery(document).ready(function() {
    ...
    jQuery('.custom-color').click(function() {
        jQuery('.custom-color').removeClass('custom-color-active');
       jQuery(this).addClass('custom-color-active') 
    });
   ...
   //смена темы в зависимости от слайда
    ...
    var info_cont = jQuery.cookie('info_cont');
    ...
    jQuery('.close-info').click(function() {
       jQuery('.info-cont').css('display','none');
       jQuery.cookie('info_cont','none',{expires: 5});
    });
...
//   });
   ...
   jQuery('.close-modal, .modal-overlay').click(function() {
    ...
    jQuery('.pdf-btn').click(function() {
        var selectedServices = jQuery('.element-list .element-item-select');
